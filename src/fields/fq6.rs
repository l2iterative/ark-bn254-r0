use crate::fields::{Fq, Fq2, Fq2Config};
use crate::BN254_FQ;
use ark_ff::{AdditiveGroup, Fp2, Fp2Config, Fp6, Fp6Config};
...
impl Fp6Config for Fq6Config {
    ...
    const FROBENIUS_COEFF_FP6_C1: &'static [Fq2] = &[
        ...
        Fq2::new(
            BN254_FQ!("2203960485148121921418603742825762020974279258880205651966"),
            Fq::ZERO,
        ),
