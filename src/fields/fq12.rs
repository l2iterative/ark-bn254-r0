use crate::fields::{Fq, Fq2, Fq6, Fq6Config};
use crate::BN254_FQ;
use ark_ff::{AdditiveGroup, Field, Fp12, Fp12Config, Fp6};
...
impl Fp12Config for Fq12Config {
    ...
    const NONRESIDUE: Fp6<Self::Fp6Config> = Fq6::new(Fq2::ZERO, Fq2::ONE, Fq2::ZERO);
    const FROBENIUS_COEFF_FP12_C1: &'static [Fq2] = &[
        ...
        Fq2::new(
            BN254_FQ!("2203960485148121921418603742825762020974279258880205651967"),
            Fq::ZERO,
        ),
